  ...
  const handleLogin = async () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to JANMITRA Supervisor Portal",
      });
      navigate('/supervisor');
    }, 1500);
  };
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <h2 className="text-xl font-semibold text-foreground">Supervisor Portal</h2>
          </div>
        </div>
        ...
        <Card className="shadow-civic">
          <CardHeader>
            <CardTitle className="text-center">Supervisor Login</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div>
                ...
                <Input
                  id="uniqueId"
                  placeholder="Enter your unique supervisor ID"
